...
New-LocalUser -Name NSC-HI -FullName "Dewey Gottlieb" -Description "NAEP StateCoordinator for this unit." -PasswordNeverExpires -Password $sec_passCoordinator
Add-LocalGroupMember -Group users -Member NSC-HI

# ***************************** Rename Computer *************************************************
$NewHostName = Read-Host "Input new hostname in this format SC2022-HI "
