...
New-LocalUser -Name NSC-RI -FullName "Jacqueline Branco" -Description "NAEP StateCoordinator for this unit." -PasswordNeverExpires -Password $sec_passCoordinator
Add-LocalGroupMember -Group users -Member NSC-RI

# ***************************** Rename Computer *************************************************
$NewHostName = Read-Host "Input new hostname in this format SC2022-RI "
