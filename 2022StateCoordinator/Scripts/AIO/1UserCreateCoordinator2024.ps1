...
New-LocalUser -Name NSC-XX -FullName "State Coordinator" -Description "NAEP StateCoordinator for this unit." -PasswordNeverExpires -Password $sec_passCoordinator
Add-LocalGroupMember -Group users -Member NSC-XX #NSC-State

# ***************************** Rename Computer *************************************************
$NewHostName = Read-Host "Input new hostname in this format SCAIO2024-XX "  #SCAIO2023-State Abbriviation
