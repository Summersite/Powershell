...
New-LocalUser -Name NSC-CO -FullName "Will Donkersgoed" -Description "NAEP StateCoordinator for this unit." -PasswordNeverExpires -Password $sec_passCoordinator
Add-LocalGroupMember -Group users -Member NSC-CO

# ***************************** Rename Computer *************************************************
$NewHostName = Read-Host "Input new hostname in this format SC2022-CO "
