...
$logfile = "\\TRUENAS\106data\backup\Laptops\NAEPIMS-WORK\logs\fileCopyLogData_$($hostName)_$($date).txt"
...
$sourcePath = "C:\Data\"
$destPath = "\\TRUENAS\106data\backup\Laptops\NAEPIMS-WORK\Data"
