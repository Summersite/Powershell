#* update help
Write-host Updating Powershell Help from Microsoft -NoNewline -ForegroundColor Cyan 
update-help
Write-host Show Powershell Version -NoNewline -ForegroundColor Cyan 
$psversiontable
Get-Module -ListAvailable -Name eq  
#* powershell version
