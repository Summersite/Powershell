...
$logfile = "$logFilePath\Quick Scan from $($hostname)_$date.log"

Set-ExecutionPolicy unrestricted -Scope CurrentUser -Force
Unblock-File \\192.168.2.101\backup\development\powershell\scans\quickScan.ps1
...
nmap -sn 192.168.2.0/24 >$logfile 